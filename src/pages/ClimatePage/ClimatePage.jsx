            ...
            >
                ...
                >
                    <img
                        ref={heroImageRef}
                        src={Background}
                        alt="Traditional Climate Design Background"
                ...
                >
                    ...
                    >
                        Traditional<br />
                        <span className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-normal">Climate Design</span>
                    </h1>
                </div>
                ...
                >
                    ...
                    >
                        <p className="text-sm sm:text-base leading-relaxed text-white/90" style={{fontFamily: 'Inter, sans-serif'}}>
                            Rumah Penghulu Abu Seman uses passive design to stay cool in a hot, humid climate without air conditioning. Features such as a ventilated roof, raised floor, and shaded openings allow hot air to escape while drawing in cooler air naturally.
                        </p>
                    </div>
                </div>
                ...
                <main className="w-full flex-1 relative">
                    ...
                    <section className="mt-8 sm:mt-12 md:mt-16 mb-8 sm:mb-12 md:mb-16 w-full">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-16">
                            {/* Bumbung Bertingkat - Left Column */}
                            <div className="flex flex-col">
                                ...
                                <div>
                                    <h3 className={`text-xl sm:text-2xl font-bold mb-2 sm:mb-3 ${getTextColor()}`} style={{fontFamily: 'Inter, sans-serif', fontWeight: 600}}>
                                        Bumbung Bertingkat (Jack Roof)
                                    </h3>
                                    <p className={`text-sm sm:text-base leading-relaxed ${getTextColor()}`} style={{fontFamily: 'Inter, sans-serif'}}>
                                        A ladder leads to a small loft used for storing rice and family valuables. It was also used as a hiding place during World War II.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col">
                                ...
                                <div>
                                    ...
                                    <p className={`text-sm sm:text-base leading-relaxed ${getTextColor()}`} style={{fontFamily: 'Inter, sans-serif'}}>
                                        The house is raised on stilts, creating a space called the kolong beneath it. This protects the house from floods and helps cool the interior by allowing cooler air from below to flow upward.
                                    </p>
                                </div>
                            </div>
                        </div>
