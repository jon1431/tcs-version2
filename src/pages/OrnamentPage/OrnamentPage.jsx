            ...
            >
                ...
                >
                    <img
                        ref={heroImageRef}
                        src={Background}
                        alt="Iconography & Ornamentation Background"
                            ...
                            <div className="flex flex-col">
                                ...
                                >
                                    ...
                                    >
                                        <img 
                                            src={Kelawang} 
                                            alt="Kerawang - Intricate Wooden Carvings"
                                            style={{
                                                width: '100%',
                                                height: '100%',
                                                objectFit: 'cover',
                                ...
                                <div>
                                    ...
                                    <p className={`text-base leading-relaxed ${getTextColor()}`} style={{fontFamily: 'Inter, sans-serif'}}>
                                        The pierced carvings provide essential ventilation when doors and windows are closed for privacy or security. This high-precision technique cuts all the way through wood, typically Meranti, to create functional negative space.
                                    </p>
                                </div>
                            </div>

                            {/* Motifs and Symbolism - Right Column */}
                            <div className="flex flex-col">
                                <div>
                                    <h3 className={`text-2xl font-bold mb-4 ${getTextColor()}`} style={{fontFamily: 'Inter, sans-serif', fontWeight: 600}}>
                                        Motifs and Symbolism
                                    </h3>
                                    <ul className={`space-y-4 ${getTextColor()}`} style={{fontFamily: 'Inter, sans-serif'}}>
                                        <li className="text-base leading-relaxed" style={{lineHeight: '1.8'}}>
                                            The carvings primarily feature floral and trailing cloud motifs, symbolizing the continuity of life and interconnectedness.
                                        </li>
                                        <li className="text-base leading-relaxed" style={{lineHeight: '1.8'}}>
